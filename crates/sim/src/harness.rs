...
fn compat_report(actor: crate::actor_harness::ActorRunReport) -> RunReport {
    RunReport {
        ...
        store: actor.store,
        published_segment_bytes: actor.published_segment_bytes,
        published_live_entry_bytes: actor.published_live_entry_bytes,
        published_dead_entry_bytes: actor.published_dead_entry_bytes,
        published_segment_overhead_bytes: actor.published_segment_overhead_bytes,
